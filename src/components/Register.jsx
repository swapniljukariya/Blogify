        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                  <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm3 8a3 3 0 11-6 0 3 3 0 016 0zm-3 7c3.86 0 7-3.14 7-7s-3.14-7-7-7-7 3.14-7 7 3.14 7 7 7z" clipRule="evenodd" />
                </svg>
              </button>
            </div>
          </div>
